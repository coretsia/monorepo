...
│   │   │       │   ├── Provider/
│   │   │       │   │   ├── KernelServiceFactory.php (KernelServiceFactory - hookInvoker()/kernelRuntime()/unitOfWorkAttributeLimits()/unitOfWorkAttributesMaxDepth()/unitOfWorkAttributesMaxKeys()/contextStore()/resetOrchestrator()/stopwatch()/uowIds()/correlationIdProvider()/correlationIds()/hooks()/logger()/tracer()/meter()/service()/uowAttributesConfig())
...
│   │   │       │       │   ├── UnitOfWorkContextInvalidException.php (UnitOfWorkContextInvalidException - atPath()/errorCode()/path()/reason()/message())
│   │   │       │       │   └── UnitOfWorkResultInvalidException.php (UnitOfWorkResultInvalidException - atPath()/errorCode()/path()/reason()/message())
│   │   │       │       ├── Hook/
