...
│   │   │       │   │   ├── BootstrapConfigResolver.php (BootstrapConfigResolver - resolve()/defaultAppEnv()/defaultPreset()/defaultDebug()/defaultEnvSourcePolicy()/isProductionLikeEnv()/isNonEmptySafeSingleLineString())
...
│   │   │       │   │   ├── BootstrapOverridesLoader.php (BootstrapOverridesLoader - load()/joinPath()/loadArrayFile()/normalizeOverrides()/isNonEmptySafeSingleLineString())
...
│   │   │       │   ├── Provider/
│   │   │       │   │   ├── KernelServiceFactory.php (KernelServiceFactory - bootstrapOverridesLoader()/bootstrapConfigResolver()/dotenvLoader()/envRepositoryBuilder()/hookInvoker()/kernelRuntime()/unitOfWorkAttributeLimits()/unitOfWorkAttributesMaxDepth()/unitOfWorkAttributesMaxKeys()/contextStore()/resetOrchestrator()/stopwatch()/uowIds()/correlationIdProvider()/correlationIds()/hooks()/logger()/tracer()/meter()/bootService()/service()/uowAttributesConfig())
...
│   │   │       │   │   ├── BootstrapOverridesLoaderReadsOnlyAppPhpTest.php (BootstrapOverridesLoaderReadsOnlyAppPhpTest - testReadsSkeletonConfigAppPhpWhenPresentAndAllowsOnlyBootOverrides()/testDoesNotReadSkeletonConfigModulesPhp()/testUnknownOverrideKeysFailDeterministicallyAndDoNotLeakRawOverrideValues()/testInvalidAllowedOverrideValueFailsWithoutLeakingRawValue()/loader()/createSkeletonRoot()/writePhpArrayFile()/writeThrowingPhpFile()/ensureDirectory()/removeDirectory()/normalizePath())
