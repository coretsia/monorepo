...
│   │   │       │       ├── Internal/
│   │   │       │       │   └── JsonLikeShapeNormalizer.php (JsonLikeShapeNormalizer - normalizeContextAttributes()/normalizeResultExtensions()/normalizeExportedErrorMap()/normalizeContextMap()/normalizeContextValue()/normalizeContextList()/normalizeResultMap()/normalizeResultValue()/normalizeResultList()/assertContextDepth()/assertSafeContextAttributeKey()/assertSafeResultExtensionKey()/isUnsafeMetadataKey()/normalizeSemanticKey()/pathForKey()/safeKeySegment()/isSafeSingleLineString()/isSafeString())
