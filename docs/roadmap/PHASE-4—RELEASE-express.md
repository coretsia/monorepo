...
adr: docs/adr/ADR-0049-validation-engine.md
ssot_refs:
...
- Required deliverables (exact paths):
  ...
  - `docs/adr/ADR-0049-validation-engine.md` — ADR locked before impl
...
- [ ] `docs/adr/INDEX.md` — register ADR-0049
...
adr: docs/adr/ADR-0050-http-client-outgoing.md
ssot_refs: []
---
...
- Required deliverables (exact paths):
  - `docs/adr/ADR-0050-http-client-outgoing.md` — ADR (locked before impl)
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0050-http-client-outgoing.md`
...
adr: docs/adr/ADR-0051-platform-filesystem-local-driver.md
ssot_refs:
...
- Required deliverables (exact paths):
  ...
  - `docs/adr/ADR-0051-platform-filesystem-local-driver.md` — ADR (locked before impl)
...
- [ ] `docs/ssot/INDEX.md` — register:
  - [ ] `docs/ssot/filesystem-path-safety.md`
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0051-platform-filesystem-local-driver.md`
...
adr: docs/adr/ADR-0052-multipart-parsing-validation-quarantine.md
ssot_refs:
...
- Required deliverables (exact paths):
  - `docs/adr/ADR-0052-multipart-parsing-validation-quarantine.md` — ADR (locked before impl)
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0052-multipart-parsing-validation-quarantine.md`
...
adr: docs/adr/ADR-0053-database-core-driver-port-querybuilder.md
ssot_refs:
...
- Required deliverables (exact paths):
  - `docs/adr/ADR-0053-database-core-driver-port-querybuilder.md` — ADR (locked before impl)
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0053-database-core-driver-port-querybuilder.md`
...
artifacts_introduced: []
adr: "docs/adr/ADR-0054-migrations-driver-agnostic.md"
ssot_refs:
...
- [ ] `docs/ssot/INDEX.md` — register:
  - [ ] `docs/ssot/migrations-ordering.md`
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0054-migrations-driver-agnostic.md`
...
adr: docs/adr/ADR-0069-queue-ports-jobs-retry.md
ssot_refs: []
---
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0069-queue-ports-jobs-retry.md`
...
adr: "docs/adr/ADR-0056-auth-session-security-lock-ports.md"
ssot_refs:
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0056-auth-session-security-lock-ports.md`
...
adr: "docs/adr/ADR-0057-session-layer-file-storage.md"
ssot_refs:
- "docs/ssot/observability-and-errors.md"
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0057-session-layer-file-storage.md`
...
adr: "docs/adr/ADR-0058-session-auth-rbac.md"
ssot_refs:
- "docs/ssot/observability-and-errors.md"
- "docs/ssot/metrics-policy.md"
- "docs/ssot/config-and-env.md"
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0058-session-auth-rbac.md`
...
adr: "docs/adr/ADR-0059-token-bearer-jwt-guard.md"
ssot_refs:
- "docs/ssot/observability-and-errors.md"
- "docs/ssot/metrics-policy.md"
- "docs/ssot/config-and-env.md"
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0059-token-bearer-jwt-guard.md`
...
adr: docs/adr/ADR-0061-csrf-signed-urls.md
ssot_refs: []
---
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0061-csrf-signed-urls.md`
...
- [ ] Docs updated:
  ...
  - [ ] ADR present: `docs/adr/ADR-0061-csrf-signed-urls.md`
- [ ] Non-goals / out of scope
...
adr: docs/adr/ADR-0062-data-encryption-key-management.md
ssot_refs: []
---
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0062-data-encryption-key-management.md`
...
- [ ] ADR present: `docs/adr/ADR-0062-data-encryption-key-management.md`
- [ ] Non-goals / out of scope
...
adr: docs/adr/ADR-0063-rate-limiting-identity-aware.md
ssot_refs: []
---
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0063-rate-limiting-identity-aware.md`
...
- [ ] ADR present: `docs/adr/ADR-0063-rate-limiting-identity-aware.md`
- [ ] Solves:
...
adr: docs/adr/ADR-0064-password-hashing.md
ssot_refs: []
---
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0064-password-hashing.md`
...
- [ ] ADR present: `docs/adr/ADR-0064-password-hashing.md`
- [ ] Solves:
...
adr: docs/adr/ADR-0065-lock-factory-reference-drivers.md
ssot_refs: []
---
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0065-lock-factory-reference-drivers.md`
...
- [ ] ADR present: `docs/adr/ADR-0065-lock-factory-reference-drivers.md`
- [ ] Solves:
  - [ ] Reference lock factory (`in_memory`, `file`) через contracts `LockFactoryInterface`
...
adr: docs/adr/ADR-0066-cache-psr16-manager-stores.md
ssot_refs: []
---
...
- [ ] `docs/adr/INDEX.md` — register:
  - [ ] `docs/adr/ADR-0066-cache-psr16-manager-stores.md`
...
- [ ] ADR present: `docs/adr/ADR-0066-cache-psr16-manager-stores.md`
- [ ] Solves:
