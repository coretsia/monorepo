...
- [Worker Control Security](./worker-control-security.md) — owner: platform/worker — ssotVersion: 1 — scope: authentication,control,credentials,redaction,runtime,worker
