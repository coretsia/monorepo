...
final class CorrelationIdFormatTest extends TestCase
{
    private const string ULID_PATTERN = '/\A[0-9A-HJKMNP-TV-Z]{26}\z/';

    public function testUlidGeneratorProducesCanonicalUppercaseUlid(): void
    {
    ...
    public function testCorrelationIdGeneratorProducesCanonicalUppercaseUlid(): void
    {
