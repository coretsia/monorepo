...
final class ModulePlanResolverIgnoresSkeletonConfigModulesPhpTest extends TestCase
{
    ...
    public function testIgnoresSkeletonConfigModulesPhpAndAppLocalModulesPhp(): void
    {
        ...
        self::writeFile(
            ...
            "<?php\nthrow new \\RuntimeException('skeleton-config-modules-php-must-not-be-read');\n",
        );

        self::writeFile(
            $skeletonRoot . '/apps/api/config/modules.php',
