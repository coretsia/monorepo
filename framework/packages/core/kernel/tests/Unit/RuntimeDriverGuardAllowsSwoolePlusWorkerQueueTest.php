...
final class RuntimeDriverGuardAllowsSwoolePlusWorkerQueueTest extends TestCase
{
    public function testAllowsSwooleHttpPlusWorkerQueueBackgroundDriver(): void
    {
        ...
        self::assertSame(HttpDriver::SWOOLE, $drivers->httpDriver());
        self::assertSame('http.swoole', $drivers->httpDriverId());
