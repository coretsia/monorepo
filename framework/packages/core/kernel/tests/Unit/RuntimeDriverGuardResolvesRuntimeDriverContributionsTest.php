...
final class RuntimeDriverGuardResolvesRuntimeDriverContributionsTest extends TestCase
{
    public function testResolveKeepsClassicHttpWithWorkerQueueContribution(): void
    {
        ...
        $drivers = new RuntimeDriverGuard()->resolve($cfg, $contributions);
    ...
    public function testResolveReplacesClassicHttpWithWorkerHttpContribution(): void
    {
        $cfg = new ArrayConfigRepository([
            'kernel' => [
                'runtime' => [
