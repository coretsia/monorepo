...
final class RuntimeDriverGuardTreatsMissingWorkerKeysAsDisabledTest extends TestCase
{
    public function testTreatsMissingWorkerEnabledAsDisabled(): void
    {
        $cfg = self::config([
    ...
    public function testTreatsMissingWorkerTaskTypeAsNoWorkerDerivedDriver(): void
    {
        $cfg = self::config([
            'kernel.runtime.frankenphp.enabled' => false,
            'kernel.runtime.swoole.enabled' => false,
    ...
    public function testAssertCompatibleAllowsMissingWorkerKeys(): void
    {
        $cfg = self::config([
            'kernel.runtime.frankenphp.enabled' => false,
            'kernel.runtime.swoole.enabled' => false,
