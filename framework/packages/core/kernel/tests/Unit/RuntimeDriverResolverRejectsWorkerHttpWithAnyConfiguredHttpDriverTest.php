...
final class RuntimeDriverResolverRejectsWorkerHttpWithAnyConfiguredHttpDriverTest extends TestCase
{
    /**
    ...
    public function testResolveRejectsWorkerHttpWithAnyNonClassicConfiguredHttpDriver(
        ...
        self::fail(
            'RuntimeDriverResolver::resolve() must reject http.worker with a non-classic configured HTTP runtime driver.'
        );
    }
