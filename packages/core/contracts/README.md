...
Package source MUST NOT import or consume repository machinery under `tools/**`.
...
- [Contracts package source](https://github.com/coretsia/monorepo/tree/main/packages/core/contracts)
