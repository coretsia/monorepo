...
final class ConfigDirectiveErrorPrecedenceMatchesCanonicalPolicyContractTest extends TestCase
{
     ...
     * @var list<string>
     */
    private const array CANONICAL_ERROR_PRECEDENCE = [
     ...
     */
    private const array CANONICAL_ERROR_CODE_MAPPING = [
    ...
    public function testCanonicalDirectiveErrorPrecedenceIsLocked(): void
    {
        self::assertSame(
            [
            ...
            self::CANONICAL_ERROR_PRECEDENCE,
        );
    }

    public function testContractCodesMapToCanonicalPolicyCodes(): void
    {
        self::assertSame(
            [
            ...
            self::CANONICAL_ERROR_CODE_MAPPING,
        );
    }

    public function testValidationCodesAreStableAsciiStrings(): void
    {
        foreach (self::CANONICAL_ERROR_PRECEDENCE as $code) {
     ...
     * validation behavior. It exists only to make the canonical precedence order
