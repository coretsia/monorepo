...
{
    public function testTraceEntriesCanBeOrderedByCanonicalSafeTraceOrder(): void
    {
        $entries = [
    ...
    public function testPrecedenceIsExportedAndPartOfCanonicalSafeTraceSortKey(): void
    {
    ...
    public function testPathIsSafeSourceFileEquivalentInCanonicalSortKey(): void
    {
        $entries = [
            new ConfigValueSource(
                type: ConfigSourceType::PackageDefault,
     ...
     * makes the canonical SSoT ordering rule executable as contract
     * evidence.
     *
