 ...
 *   utility.
 *
 * This provider must not emit stdout/stderr, use `devtools/*` packages, consume
 * repository machinery under `tools/**` or generated architecture artifacts,
 * read filesystem or environment sources, resolve services, start runtime
 * lifecycle, or introduce static mutable snapshots during definition production.
 */
