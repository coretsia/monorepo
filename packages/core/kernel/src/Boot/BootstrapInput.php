 ...
 * services. This class validates that `applicationRoot` is a non-empty safe
...
final readonly class BootstrapInput
{
    ...
    /**
     * Entrypoint-provided application root path.
     *
     ...
     *
     * The target is never inferred by scanning apps/<app>.
     */
     ...
     *
     * The value is relative to BootstrapConfig::applicationRoot().
     */
