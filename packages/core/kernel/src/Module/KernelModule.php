 ...
 *
 * It exposes Kernel module metadata and the provider list without owning
 * runtime discovery or manifest construction, and without performing filesystem
 * scanning, container construction, config loading, runtime lifecycle execution,
 * reset execution, hook dispatching, or transport adapter behavior.
 *
