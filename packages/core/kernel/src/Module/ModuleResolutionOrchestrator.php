 ...
 *
 * Phase A preset policy and effective module selection inputs:
 *
 ...
 *
 * This orchestrator intentionally does not:
 *
 * - read config/modules.php;
 * - read apps/<app>/config/modules.php;
 * - scan apps/<app>;
 ...
 */
final readonly class ModuleResolutionOrchestrator
{
    ...
    public function __construct(
        ...
        private ModuleSelectionFactory $moduleSelectionFactory,
    ...
    public function resolve(BootstrapConfig $bootstrapConfig): ModuleResolution
    {
    ...
    private static function outcomeForException(ModuleResolutionException $exception): string
    {
        return match (true) {
            ...
            $exception instanceof CanonicalPresetOverrideException => 'preset_invalid',
            $exception instanceof InvalidModuleSelectionException => 'selection_invalid',
    ...
    {
        try {
            return ModuleId::fromString($value)->value() === $value;
