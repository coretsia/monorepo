...
final class LifecycleFailingObservability extends AbstractLogger implements TracerPortInterface, MeterPortInterface
{
    ...
    {
        return new \RuntimeException('lifecycle-fixture-observability-failure');
    }
}
