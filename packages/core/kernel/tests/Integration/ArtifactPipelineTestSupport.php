...
final class ArtifactPipelineTestSupport
{
     ...
     */
    public static function writeRootConfig(string $applicationRoot, array $config): void
    {
        self::writePhpReturn($applicationRoot . '/config/roots.php', $config);
    }
    ...
    public static function compileArtifacts(
        ...
        self::writeRootConfig($applicationRoot, $config);
    ...
    public static function artifactRoot(
        ...
        return \rtrim($applicationRoot, '/\\') . '/' . $artifactsCacheDir . '/web';
    }
    ...
    public static function artifactPaths(
        ...
        $directory = \rtrim($applicationRoot, '/\\') . '/' . $artifactsCacheDir . '/web';
