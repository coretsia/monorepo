...
final class BootstrapSystemEnvOverridesDotenvUnderAllowSystemPolicyTest extends TestCase
{
    ...
    {
        $applicationRoot = self::createApplicationRoot('allow-system-precedence');
        ...
        try {
            ...
            self::withSystemEnv(
                ...
                callback: static function () use (
                    ...
                    $repository = self::buildAllowSystemRepository($applicationRoot);
    ...
    {
        $applicationRoot = self::createApplicationRoot('system-source-metadata');
        $suffix = self::uniqueSuffix();
    ...
    {
        $applicationRoot = self::createApplicationRoot('dotenv-fallback-source-metadata');
        $suffix = self::uniqueSuffix();
        ...
        try {
            ...
            self::withSystemEnv(
                ...
                callback: static function () use ($applicationRoot, $dotenvOnly): void {
                    $repository = self::buildAllowSystemRepository($applicationRoot);
    ...
    private static function buildAllowSystemRepository(string $applicationRoot): EnvRepositoryInterface
    {
