...
final class CacheVerifyDetectsArtifactByteDriftTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->applicationRoot = ArtifactPipelineTestSupport::temporaryRoot('cache-verify-byte-drift');
    ...
    {
        $path = ArtifactPipelineTestSupport::currentArtifactPath($this->applicationRoot, 'config.php');
    ...
    public function testVerifyExplainDoesNotLeakRawPayloadValuesOrAbsolutePaths(): void
    {
        ...
        self::assertStringNotContainsString($this->applicationRoot, $encoded);
