...
final class CompilerAndVerifierUseSameGraphFingerprintTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->applicationRoot = ArtifactPipelineTestSupport::temporaryRoot(
    ...
    public function testCompilerAndVerifierUseSameGraphBoundFingerprint(): void
    {
        ...
        self::assertSame(
            ...
            \array_values(
                \array_unique(
                    self::artifactFingerprints($this->applicationRoot),
                )
            ),
        );
     ...
     */
    private static function artifactFingerprints(string $applicationRoot): array
    {
        $fingerprints = [];
