...
$foundationConfig = require $repoRoot . '/packages/core/foundation/config/foundation.php';
$kernelProviderConfig = require $repoRoot . '/packages/core/kernel/config/kernel.php';
