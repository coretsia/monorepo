...
final class ConfigAggregateAndSplitFilesMergeOrderTest extends TestCase
{
    ...
    public function testApplicationRootsAndSplitRootFilesAreLoadedAndSplitOverridesAggregateAtSameLayer(): void
    {
        self::writePhpReturn(
            ...
            [
                'kernel' => [
                    'boot' => [
                        'default_app' => 'from-application-roots',
                        'default_env' => 'from-application-roots',
                    ],
                ],
            ],
        );
        ...
        self::writePhpReturn(
            ...
            [
                'boot' => [
                    'default_env' => 'from-application-split-root',
                ],
            ],
        );
    ...
    public function testAppSplitRootOverridesAppRootsAtSameLayer(): void
    {
        ...
        self::assertSame(
            [
                'apps/web/config/roots.php',
                'apps/web/config/kernel.php',
            ],
            \array_column($loaded['entries'], 'path'),
        );
