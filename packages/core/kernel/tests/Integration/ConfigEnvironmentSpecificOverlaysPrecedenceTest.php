    ...
    public function testEnvironmentAndAppLayersOverrideInCanonicalOrderAndEnvOverlayWins(): void
    {
        self::writePhpReturn(
            ...
            [
                'kernel' => [
                    'boot' => [
                        'default_app' => 'from-application-shared',
                        'default_env' => 'from-application-shared',
                    ],
                ],
            ],
        );
        ...
        self::writePhpReturn(
            ...
            [
                'kernel' => [
                    'boot' => [
                        'default_env' => 'from-application-environment',
                    ],
                ],
            ],
        );
        ...
        self::assertSame(
            [
                'config/roots.php',
                'config/environments/prod/roots.php',
                'apps/web/config/roots.php',
                'apps/web/config/environments/prod/roots.php',
            ],
