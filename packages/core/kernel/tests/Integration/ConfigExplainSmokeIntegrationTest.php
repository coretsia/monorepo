    ...
    public function testExplainReturnsBaselineSafeDeterministicShape(): void
    {
        ...
        $sources = [
            ...
            new ConfigValueSource(
                ...
                root: 'kernel',
                sourceId: 'application-config/app_target_environment/split_root/kernel',
                path: 'apps/main/config/environments/prod/kernel.php',
            ...
            new ConfigValueSource(
                type: ConfigSourceType::AppConfig,
                root: 'custom',
                sourceId: 'application-config/app_target_environment/split_root/custom',
                path: 'apps/main/config/environments/prod/custom.php',
                keyPath: 'custom',
                directive: null,
                precedence: 401,
                redacted: false,
        ...
        self::assertSame('application-config/app_target_environment/split_root/kernel', $defaultEnvPath['sourceId']);
