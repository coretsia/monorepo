...
final class ConfigPrecedenceMatrixTest extends TestCase
{
    public function testSsoTDocsDeclareTheActivePhaseBRankOrder(): void
    {
        ...
        self::assertStringContainsString('ConfigSourceType::ApplicationConfig', $matrix);
        ...
        $entries = [
            ...
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'app_target_shared_root',
                        ],
                    ],
                ],
            ],
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'application_shared_aggregate',
                        ],
                    ],
                ],
            ],
            ...
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'app_target_environment_root',
                        ],
                    ],
                ],
            ],
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'app_target_shared_aggregate',
                        ],
                    ],
                ],
            ],
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'application_environment_aggregate',
                        ],
                    ],
                ],
            ],
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'application_shared_root',
                        ],
                    ],
                ],
            ],
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'application_environment_root',
                        ],
                    ],
                ],
            ],
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'app_target_environment_aggregate',
                        ],
                    ],
                ],
            ],
        ...
        $entries = [
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_app' => 'from_application_shared_aggregate',
                            'default_env' => 'from_application_shared_aggregate',
                        ],
                    ],
                ],
            ],
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'from_application_shared_root',
                        ],
                    ],
                ],
            ],
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'from_application_environment_aggregate',
                        ],
                    ],
                ],
            ],
            [
                ...
                'config' => [
                    'kernel' => [
                        'boot' => [
                            'default_env' => 'from_application_environment_root',
                        ],
                    ],
                ],
            ],
