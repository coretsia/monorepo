...
final class KernelArtifactObservabilityDoesNotChangeBehaviorTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->applicationRoot = ArtifactPipelineTestSupport::temporaryRoot('artifact-observability-behavior');
    }
    ...
    {
        $targetPath = $this->applicationRoot . '/var/cache/web/custom.txt';
    ...
    public function testFailingLoggerDoesNotFailCacheVerification(): void
    {
        ...
        $result = self::cacheVerifier(
            ...
            bootstrapConfig: self::bootstrapConfig($this->applicationRoot),
    ...
    public function testObservabilityFailuresDoNotChangeCleanDirtyInvalidVerificationSemantics(): void
    {
        ...
        $clean = self::verifyWithFailingObservability($this->applicationRoot);
        ...
        $dirty = self::verifyWithFailingObservability($this->applicationRoot);
        ...
        $invalid = self::verifyWithFailingObservability($this->applicationRoot);
     ...
     */
    private static function verifyWithFailingObservability(string $applicationRoot): array
    {
        return self::cacheVerifier(
            ...
            bootstrapConfig: self::bootstrapConfig($applicationRoot),
            moduleResolution: ArtifactPipelineTestSupport::moduleResolution(),
            env: self::envRepository(),
            kernelConfig: ArtifactPipelineTestSupport::kernelConfig(),
            configSources: ConfigSourceSet::empty(),
    ...
    private static function bootstrapConfig(string $applicationRoot): BootstrapConfig
    {
