...
final class OptionalMissingDoesNotFailTest extends TestCase
{
    public function testOptionalMissingModulesDoNotFailResolution(): void
    {
        $plan = self::resolver()->resolve(
            app: 'api',
            installed: self::manifest([
                self::descriptor('core.kernel', requires: ['core.foundation']),
