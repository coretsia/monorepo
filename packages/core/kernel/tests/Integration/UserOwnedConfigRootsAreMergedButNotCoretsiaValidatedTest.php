...
final class UserOwnedConfigRootsAreMergedButNotCoretsiaValidatedTest extends TestCase
{
    ...
    public function testCustomRootsAreMergedExplainedFingerprintableAndUnvalidatedWithoutRules(): void
    {
        ...
        $sources = [
            new ConfigValueSource(
                ...
                root: 'custom_aggregate',
                sourceId: 'application-config/application_shared/aggregate_root_map/application_config_roots.php/custom_aggregate',
                path: 'config/roots.php',
            ...
            new ConfigValueSource(
                type: ConfigSourceType::ApplicationConfig,
                root: 'custom_split',
                sourceId: 'application-config/application_shared/split_root_subtree/application_config_custom_split.php/custom_split',
                path: 'config/custom_split.php',
            ...
            new ConfigValueSource(
                type: ConfigSourceType::ApplicationConfig,
                root: 'kernel',
                sourceId: 'application-config/application_shared/aggregate_root_map/application_config_roots.php/kernel',
                path: 'config/roots.php',
                keyPath: 'kernel',
                directive: null,
                precedence: 100,
    ...
    private static function loader(): ApplicationConfigLoader
    {
