...
- Forbidden consumers:
  - Coretsia publishable products outside `devtools/*`, including:
    - `core/*`
    - `platform/*`
    - `integrations/*`
    - `presets/*`
...
Coretsia publishable products outside `devtools/*` and consuming applications MUST NOT depend on `coretsia/devtools-internal-toolkit`.
...
$path = Path::normalizeRelative(
    '/repo/packages/devtools/internal-toolkit',
    '/repo',
);
...
```json
{"path":"packages/devtools/internal-toolkit","slug":"internal_toolkit"}
```
...
- [Internal Toolkit package source](https://github.com/coretsia/monorepo/tree/main/packages/devtools/internal-toolkit)
