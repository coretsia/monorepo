...
final class OutputRedactionDoesNotLeakTest extends TestCase
{
    public function testRedactionDoesNotLeakSecretsOrAbsolutePaths(): void
    {
        ...
        $appCli = $applicationRoot . '/config/cli.php';
        ...
        $hadApplicationRoot = \is_dir($applicationRoot);
        ...
        try {
            if (!\is_dir($appConfigDir)) {
                ...
                self::assertTrue($ok, 'Failed to create application config dir: ' . $appConfigDir);
            }
            ...
            self::assertStringNotContainsString('C:\\private\\project', $out);
            ...
            if ($hadFile) {
                ...
                if (!$hadApplicationRoot && \is_dir($applicationRoot)) {
