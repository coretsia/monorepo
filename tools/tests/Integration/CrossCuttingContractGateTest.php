...
final class CrossCuttingContractGateTest extends ToolContractTestCase
{
    ...
    private function createCrossCuttingGateSandbox(
        ...
        $this->writeBytesExact(
            ...
            "{\n"
            . "  \"name\": \"coretsia/cross-cutting-fixture\",\n"
            . "  \"type\": \"project\"\n"
            . "}\n",
        );
        ...
        foreach (
            [
                'core/contracts' => 'coretsia/core-contracts',
                'core/foundation' => 'coretsia/core-foundation',
                'platform/logging' => 'coretsia/platform-logging',
        ...
        $this->writeBytesExact(
            $sandbox . '/tools/gates/cross_cutting_contract_gate.php',
            $this->readBytes(
                $this->repoRoot()
...
PHP,
    ...
    {
        $this->writeBytesExact(
            $sandbox . '/packages/core/contracts/src/Runtime/ResetInterface.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
    ...
    {
        $this->writeBytesExact(
            $sandbox . '/packages/core/foundation/src/Tag/ReservedTags.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
    ...
    {
        $this->writeBytesExact(
            $sandbox . '/packages/core/foundation/config/foundation.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
            . "return [\n"
            . "    'reset' => [\n"
    ...
    private function writeStatefulService(string $sandbox, bool $implementsResetInterface): void
    {
        ...
        $this->writeBytesExact(
            $sandbox . '/packages/core/foundation/src/Fixture/StatefulService.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
    ...
    private function writeStatefulProvider(string $sandbox, ?string $resetTagExpression): void
    {
        ...
        $this->writeBytesExact(
            $sandbox . '/packages/core/foundation/src/Provider/FixtureServiceProvider.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
    ...
    {
        $this->writeBytesExact(
            $sandbox . '/packages/core/contracts/src/Context/ContextKeys.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
        ...
        $this->writeBytesExact(
            $sandbox . '/packages/core/foundation/src/Context/ContextStore.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
        ...
        $this->writeBytesExact(
            $sandbox . '/packages/core/foundation/src/Context/ContextStorePolicy.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
            . "namespace Coretsia\\Foundation\\Context;\n\n"
        ...
        $this->writeBytesExact(
            $sandbox . '/packages/core/foundation/src/Observability/CorrelationIdProvider.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
    ...
    private function writeFoundationContextProvider(string $sandbox, bool $verifiedEffectiveResetTagVariable): void
    {
        ...
        $this->writeBytesExact(
            $sandbox . '/packages/core/foundation/src/Provider/FoundationServiceFactory.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
            . "namespace Coretsia\\Foundation\\Provider;\n\n"
        ...
        $this->writeBytesExact(
            $sandbox . '/packages/core/foundation/src/Provider/FoundationServiceProvider.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
            . "namespace Coretsia\\Foundation\\Provider;\n\n"
    ...
    {
        $this->writeBytesExact(
            $sandbox . '/packages/core/foundation/src/Provider/UnrelatedService.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
            . "namespace Coretsia\\Foundation\\Provider;\n\n"
    ...
    {
        $this->writeBytesExact(
            $sandbox . '/packages/platform/logging/src/BadContextStoreConsumer.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
    ...
    {
        $this->writeBytesExact(
            $sandbox . '/packages/platform/logging/src/ContextKeysConsumer.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
            . "namespace Coretsia\\Platform\\Logging;\n\n"
            . "use Coretsia\\Contracts\\Context\\ContextKeys;\n\n"
    ...
    {
        $this->writeBytesExact(
            $sandbox . '/packages/platform/logging/src/LegacyFoundationContextKeysConsumer.php',
            "<?php\n\n"
            . "declare(strict_types=1);\n\n"
            . "namespace Coretsia\\Platform\\Logging;\n\n"
