...
final class ReservedTagsRegistryGateTest extends TestCase
{
    ...
    public function testFailsWhenReservedTagsMissesTagFromDocs(): void
    {
        ...
        $this->assertGateFailure(
            ...
            [
                ...
                'packages/core/foundation/src/Tag/ReservedTags.php: reserved-tag-constant-missing:CLI_COMMAND',
            ],
        );
    }
    ...
    public function testFailsWhenReservedTagsConstValueDiffers(): void
    {
        ...
        $this->assertGateFailure(
            ...
            [
                'CORETSIA_RESERVED_TAGS_REGISTRY_DRIFT',
                'packages/core/foundation/src/Tag/ReservedTags.php: reserved-tag-constant-value-mismatch:CLI_COMMAND',
                'packages/core/foundation/src/Tag/ReservedTags.php: reserved-tag-extra-public-constant:CLI_COMMAND',
            ],
        );
    }
    ...
    public function testFailsWhenAnyPackageHasProviderTagsFile(): void
    {
        ...
        $this->writeFile(
            $root . '/packages/platform/example/src/Provider/Tags.php',
            <<<'PHP'
<?php
...
PHP,
        ...
        $this->assertGateFailure(
            ...
            [
                'CORETSIA_RESERVED_TAGS_REGISTRY_DRIFT',
                'packages/platform/example/src/Provider/Tags.php: provider-tags-file-forbidden',
            ],
        );
    }
    ...
    public function testFailsWhenAnotherPackageDefinesReservedTagLiteralConstant(): void
    {
        ...
        $this->writeFile(
            $root . '/packages/platform/example/src/Internal/LocalTags.php',
            <<<'PHP'
<?php
...
PHP,
        ...
        $this->assertGateFailure(
            ...
            [
                'CORETSIA_RESERVED_TAGS_REGISTRY_DRIFT',
                'packages/platform/example/src/Internal/LocalTags.php: reserved-tag-local-constant-forbidden:CLI_COMMAND',
            ],
        );
    }
...
PHP,
    ...
    public function testFailureOutputIsDeterministicRepoRelativeSortedAndDoesNotContainAbsolutePaths(): void
    {
        ...
        $this->writeFile(
            $root . '/packages/platform/zeta/src/Provider/Tags.php',
            <<<'PHP'
<?php
...
PHP,
        ...
        $this->writeFile(
            $root . '/packages/platform/alpha/src/Internal/LocalTags.php',
            <<<'PHP'
<?php
...
PHP,
        ...
        self::assertSame(
            [
                'CORETSIA_RESERVED_TAGS_REGISTRY_DRIFT',
                'packages/core/foundation/src/Tag/ReservedTags.php: reserved-tag-constant-missing:CLI_COMMAND',
                'packages/platform/alpha/src/Internal/LocalTags.php: reserved-tag-local-constant-forbidden:CLI_COMMAND',
                'packages/platform/zeta/src/Provider/Tags.php: provider-tags-file-forbidden',
            ],
            $lines,
        );
        ...
        foreach ($lines as $line) {
            ...
            self::assertMatchesRegularExpression('/\A(?:CORETSIA_[A-Z0-9_]+|packages\/.+)\z/', $line);
        }
    ...
    private function createFixtureRoot(
        ...
        $this->writeFile(
            $root . '/composer.json',
            "{\n"
            . "  \"name\": \"coretsia/reserved-tags-fixture\",\n"
            . "  \"type\": \"project\"\n"
            . "}\n",
        );

        self::assertTrue(
            \mkdir($root . '/tools', 0777, true),
        );

        foreach (
            [
                'core/foundation' => 'coretsia/core-foundation',
                'platform/example' => 'coretsia/platform-example',
                'platform/alpha' => 'coretsia/platform-alpha',
                'platform/zeta' => 'coretsia/platform-zeta',
            ] as $packageId => $composerName
        ) {
...
MD,
        ...
        $this->writeFile(
            $root . '/packages/platform/example/src/ExampleService.php',
            <<<'PHP'
<?php
...
PHP,
    ...
    private function writePackageManifest(
        string $root,
        string $packageId,
        string $composerName,
    ): void {
        $this->writeFile(
            $root . '/packages/' . $packageId . '/composer.json',
            "{\n"
            . "  \"name\": "
            . \json_encode(
                $composerName,
    ...
    private function writeReservedTags(string $root, array $constants): void
    {
        ...
        $this->writeFile(
            $root . '/packages/core/foundation/src/Tag/ReservedTags.php',
            <<<PHP
<?php
...
PHP,
    ...
    private function runGate(string $root): array
    {
        $command = [
            \PHP_BINARY,
            $this->repoRoot() . '/tools/gates/reserved_tags_registry_gate.php',
            '--root=' . $root,
        ];
    ...
    {
        return RepositoryContext::discoverFrom(__DIR__)->repoRoot();
    }
